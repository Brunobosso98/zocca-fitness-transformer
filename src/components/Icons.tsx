...
export const NutritionIcon = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    <path d="M20 9c0 4.418-3.582 8-8 8s-8-3.582-8-8 3.582-8 8-8 8 3.582 8 8z" />
    <path d="M12 14v7" />
    <path d="M8 19h8" />
    <path d="M15 13a3 3 0 100-6 3 3 0 000 6z" />
    <path d="M9 13a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
export const CheckmarkIcon = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
